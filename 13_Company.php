...
Design a company registration form having the following fields
 = [companyID, companyName, Location, Department]. 
Write a PHP script to display all the registered companies and 
provide a search bar for searching the companies located in a specific city.
